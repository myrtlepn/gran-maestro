...
import {
  ...
  roleMappingEvidenceAbsolutePath,
} from './lib/codex-plugin-discovery-smoke.mjs';

const outputPath = process.argv[2] || roleMappingEvidenceAbsolutePath;
...
try {
  ...
  process.stderr.write(
    `Failed to write DOD-006 role mapping evidence to ${outputPath}. ` +
