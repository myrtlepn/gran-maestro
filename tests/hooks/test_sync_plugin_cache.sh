...
write_hooks_fixture() {
  ...
  cp "$REPO_ROOT/hooks/lib/bootstrap.bash" "$project_root/hooks/lib/bootstrap.bash"
  cp "$REPO_ROOT/hooks/lib/logging.bash" "$project_root/hooks/lib/logging.bash"
  cp "$REPO_ROOT/hooks/lib/session_identity.bash" "$project_root/hooks/lib/session_identity.bash"
