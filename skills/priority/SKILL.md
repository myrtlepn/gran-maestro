---
name: priority
description: "사용자가 $mst:priority 또는 /mst:priority을 명시적으로 호출하거나 MST/Gran Maestro/Maestro의 priority 기능 사용을 명시적으로 요청한 경우에만 실행합니다. 일반 요청에는 자동 활성화하지 않습니다."
user-invocable: true
...
<!-- mst-session-class: identity-required; root-source: existing REQ derived from TASK argument -->
